...
export default {
  validations: {
    name: {
      ...
      maxLength:helpers.withMessage(I18nGlobal.t(resources.Must_be_less_than_100.key), maxLength(100)),
      matchesRegex:helpers.withMessage(I18nGlobal.t(resources.Cannot_Contain_Slash.key), CustomValidators.matchesRegex(/^[^\/]*$/)),
