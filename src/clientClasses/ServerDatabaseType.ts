...
public get databaseGroup():string { return this._databaseGroup; }public set databaseGroup(v:string) {this._databaseGroup=v;this.promises.push(Global.setTablePropertyValueById(this.id, 'databaseGroup',v,this.table,this.promises))};
