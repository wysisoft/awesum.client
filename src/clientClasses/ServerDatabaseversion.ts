...
public get databaseid(): number | null | null { return this._databaseid; }public set databaseid(v: number | null | null) {this._databaseid=v;this.promises.push(Global.setTablePropertyValueById(this.id, 'databaseid',v,this.table,this.promises))}
    private _databasejson: string | null = null;
public get databasejson(): string | null | null { return this._databasejson; }public set databasejson(v: string | null | null) {this._databasejson=v;this.promises.push(Global.setTablePropertyValueById(this.id, 'databasejson',v,this.table,this.promises))}
    private _updatedate: string | null = null;
public get updatedate(): string | null | null { return this._updatedate; }public set updatedate(v: string | null | null) {this._updatedate=v;this.promises.push(Global.setTablePropertyValueById(this.id, 'updatedate',v,this.table,this.promises))}
